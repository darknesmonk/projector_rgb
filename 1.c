 ...
 #asm("sei")
  ...
  put_char("",1000);       
     ...
     writeocr();
      ...
      strcat(buffer,"c");
       ...
       put_char("AVR ATMEGA 8",2000);     
           delay_s(10);    
            put_char("ÃÀÎÓ ÑÏÎ ÁÌÒ",2000);     
           delay_s(10);  
           put_char("ÊÐÅÀÒÈÂ",2000);     
           delay_s(10);  
           put_char("Ã. ÁÓÃÓËÜÌÀ",2000);     
           delay_s(10);     
           put_char("ÄËß ÊÀÇÀÍÈ",2000);     
           delay_s(10);    
                put_char("=) :) ^_^ ;-)",2000);     
           delay_s(10);  
    /*   put_char("ã. Áàâëû",2000);  
        delay_s(10);        
          put_char("Ñàøà <3 Ñâåòà",2000);     
            delay_s(10); 
          put_char("=) :) ^_^ ;-)",2000);     
           delay_s(10);  
            put_char("Íàéòè ðàáîòó!",2000);     
           delay_s(10);  
           put_char("È êâàðòèðó :)",2000);     
           delay_s(10);     
           put_char("Çàðïëàòà 45000ð",2000);     
           delay_s(10);  
        */                                      
           fillnil (  buffer );
   ...
   delay_ms(1000);  
    ...
    fillnil (  buffer );
  ltoa(  temper, buffer);  *buffer=*strcat("Òåìïåðàòóðà: ",buffer);   put_char(buffer,1000);  
    delay_s(5);
   fillnil (  buffer );
  ...
  ltoa(  t.hour, buffer);   
 *buffer=*strcat("×àñîâ: ",buffer);
 put_char(buffer,1000);  
      delay_s(5);
       fillnil (  buffer );
     ltoa(  t.min, buffer);    
     
     *buffer=*strcat("Ìèíóò: ",buffer); 
 put_char(buffer,1000);  
      fillnil (  buffer );
  delay_s(5);
    }
...
RC_FLAG=0;
  ...
  while(1){
    rc=0;       
          ...
          put_char("ÃÀÎÓ ÑÏÎ ÁÌÒ",1000);     
           delay_s(10);  
        put_char("ÑÀÉÒ: bumate.ru",1000); 
         delay_s(10);   
          put_char("Ìàðêèí 29471",1000); 
         delay_s(10);  
          put_char("ÊÍÈÒÓ-ÊÀÈ 2015",1000); 
         delay_s(10);   
            put_char(":-) :-D =) ^_^",1000); 
         delay_s(10);  
          bg=(bg>6)?3:(bg+1);   
